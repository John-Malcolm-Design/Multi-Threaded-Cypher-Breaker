...
// Reccommend lenth of key for optimum security

public class Runner {
	
	public static void main(String[] args) throws Exception{
		//String cypherText = "TTFOHATGRNREEANOETYRCIMHHAKT";
		//CypherBreaker cp = new CypherBreaker(cypherText);
		
		FileParser fp = new FileParser();
		String plainText = fp.parsePlainText("/Users/johnmalcolm/Google Drive/Java/javaspace/OOP_Rail_Cypher_Resources/wp-intro.txt");
		System.out.println("Finished parsing file!");
		System.out.println(plainText);
		String cypherText2 = encrypt(plainText, 6);
		CypherBreaker cp = new CypherBreaker(cypherText2);
